...
public class ChessHeuristics {
    ...
    public static boolean randomNoise = false;
...
//lebo od spodu lava je brana ako 0,1,2....
    ...
    public static int[] kingTable = {
     ...
     public static int[] endKingTable = {
            -50,-40,-40,-20,-20,-40,-40,-50,
    ...
    public static HashMap<Integer, Integer> pieceValues = new HashMap<>() {{
        put(5, 100);
        put(3, 320);
        put(4, 330);
        put(6, 500);
